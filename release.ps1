...
$appName = "BushDiversTracker" # Replace with your application project name.
$projDir = "BushDiversTracker" # Replace with your project directory (where .csproj resides).
